...
- [x] **MISS-01**: A CallRail webhook endpoint (`POST /api/webhooks/callrail`) receives call events and verifies their authenticity (token/signature) before processing
